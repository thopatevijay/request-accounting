    ...
    <nav className="bg-white shadow-md p-4 flex justify-between items-center">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex space-x-4">
          <a href="/dashboard" className="text-gray-600 hover:text-blue-600 flex items-center">
            <FiHome className="mr-1" />
            Dashboard
          </a>
          <a href="/create-invoice" className="text-gray-600 hover:text-blue-600 flex items-center">
